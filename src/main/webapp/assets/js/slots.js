...
//	        		alert(data);
	...
	function getRequestsByStudentIdAndCounselorId(student_id,counselor_id){
		...
		$.ajax({
			url:"webapi/Student_Slot_Request/getRequestsByStudentIdAndCounselorId",
			data: object,
...
//	        		alert(data);
	...
	function getBookingsByStudentIdAndCounselorId(student_id,counselor_id){
		...
		$.ajax({
			url:"webapi/StudentBookingHistory/getBookingsByStudentIdAndCounselorId",
			data: object,
//			url:"http://localhost:8080/flipkart/webapi/items/getByPrice",
//			url:"http://localhost:8080/flipkart/webapi/items/getReport",
			type:"POST",
...
//		alert(slot_id)
		...
		$.ajax({
			url:"webapi/Student_Slot_Request/addRequest",
			data: object,
//			url:"http://localhost:8080/flipkart/webapi/items/getByPrice",
//			url:"http://localhost:8080/flipkart/webapi/items/getReport",
			type:"POST",
