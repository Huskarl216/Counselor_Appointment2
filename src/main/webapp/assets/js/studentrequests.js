$(document).ready(function () {
    ...
    */
	...
	function getDatesByCounselorId(coun_id){
		...
		$.ajax({
			url:"webapi/Date/getDatesByCounselorId/"+coun_id,
			type:"POST",
			cache:false,
			contentType:false,
			processData: false,
...
//	        		getBookingsByStudentIdAndCounselorId(1,coun_id);
	...
	function getSlotsByDateId(date_id){
		...
		$.ajax({
			url:"webapi/Slot/getSlotsByDateId/"+date_id,
			type:"POST",
			cache:false,
			contentType:false,
			processData: false,
	...
	function getRequestsBySlotIdWithStudentNames(slot_id){		
		$.ajax({
			url:"webapi/Student_Slot_Request/getRequestsBySlotIdWithStudentNames/"+slot_id,
			type:"POST",
			cache:false,
			contentType:false,
			processData: false,
	...
	function getBookingBySlotIdWithStudentNames(slot_id){		
		$.ajax({
			url:"webapi/StudentBookingHistory/getBookingBySlotIdWithStudentNames/"+slot_id,
			type:"POST",
			cache:false,
			contentType:false,
			processData: false,
...
//		alert(slot_id)
		...
		$.ajax({
			url:"webapi/Counselor/acceptRequest",
			data: object,
